...
#define LOG_MULTIDIM_LHIST_SIZE     9
...
#define NHIST 13        // 15 tagged tables + 1 bimodal table
...
int m[NHIST + 1] =      {0, 3, 8, 12, 17, 33, 35, 67, 97, 138, 195, 330, 517, 1193};
